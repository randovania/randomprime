...
pub struct ActorParameters {
    ...
    pub scan_parameters: ScannableParameters,

    pub xray_model: ResId<CMDL>,
    pub xray_skin: ResId<CSKR>,

    pub thermal_model: ResId<CMDL>,
    pub thermal_skin: ResId<CSKR>,
    ...
    pub thermal_damage_magnitude: f32,
}
...
pub struct LightParameters {
    ...
    pub max_shadow_height: f32,
    pub ambient_color: GenericArray<f32, U4>, // RGBA
    pub make_lights: u8,
