...
pub struct Water<'r> {
    ...
    pub pattern_map_1: u32,
    pub pattern_map_2: u32,
    pub color_map: u32,
    pub bump_map: u32,
    pub env_map: u32,
    pub env_bump_map: u32,
    pub bump_map_dir: GenericArray<f32, U3>,
    pub bump_scale: f32,
    ...
    pub splash_sfx_1: u32,
    pub splash_sfx_2: u32,
    pub splash_sfx_3: u32,
    pub tile_size: f32,
