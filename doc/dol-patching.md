...
- Fields in the free tail (the `completion` counter at offset 76 and its `completion_max` denominator at offset 80) are **not** stamped. The constructor's zeroing gives them a 0 start, and their owning feature mutates them in place.
