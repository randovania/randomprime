...
fn test_ppcasm() {
    ...
    assert_eq!(
        &asm.encoded_bytes()[..],
        &[
            0x80, 0x79, 0x08, 0xb8u8, 0x80, 0x63, 0x00, 0x00, 0x80, 0x83, 0x00, 0xdc, 0x80, 0xa3,
            0x00, 0xd4, 0x7c, 0x84, 0x28, 0x14, 0x80, 0xa3, 0x00, 0xe4, 0x7c, 0x84, 0x28, 0x14,
            0x54, 0x84, 0x10, 0x3a, 0x48, 0x00, 0x00, 0x05, 0x7c, 0xc8, 0x02, 0xa6, 0x7c, 0xc4,
            0x30, 0x14, 0xc0, 0x06, 0x00, 0x10, 0x48, 0x00, 0x00, 0x6c, 0x00, 0x00, 0x00, 0x00,
            0x3d, 0xcc, 0xcc, 0xcd, 0x3e, 0x4c, 0xcc, 0xcd, 0x3f, 0x00, 0x00, 0x00,
        ] as &[u8]
    );
    ...
    assert_eq!(
        &asm.encoded_bytes()[..],
        &[0x25, 0x30, 0x33, 0x64, 0x2f, 0x25, 0x30, 0x33, 0x64, 0x00, 0x00, 0x00,]
    );
}
